...
class Memory(Module):
    def __init__(self, memory_size = 100, prompt_size = 6, temperature=0.1, cont_temp=0.07,  device = "cuda:0", lambda_factor = None):
        ...
        self.hidden_features_1 = self.in_features // 2
        self.hidden_features_2 = self.hidden_features_1 //2
        self.lambda_factor = lambda_factor

        self.latent_feature = 24
        self.contrastive_out= 24 #For contrastive MLP output size
        self.out_features = 24
        ...
        self.contrastive_mlp = Sequential(
            ...
            Linear(in_features= 24, out_features=24),
            ReLU(),
            Linear(in_features=24, out_features=self.contrastive_out),
        )
